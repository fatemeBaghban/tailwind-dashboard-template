  ...
  const data = [
    {
      menu: "بازاریابی",
      child: [
        { name: "پیامک", link: "/", secChild: [{ name: "ایجاد رویداد" }] },
        { name: "child2", link: "/", secChild: [{ name: "ایجاد رویداد" }] },
        { name: "child3", link: "/", secChild: [{ name: "ایجاد رویداد" }] },
      ],
    },
    {
      menu: "menu2",
      child: [
        { name: "child1", link: "/", secChild: [{ name: "ایجاد رویداد" }] },
        { name: "child2", link: "/", secChild: [{ name: "ایجاد رویداد" }] },
        { name: "child3", link: "/", secChild: [{ name: "ایجاد رویداد" }] },
      ],
    },
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              >
                {(handleClick, open, childOpen, secChildOpen) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium ms-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                              Dashboard
                            </span>
                          </div>
                          {/* Icon */}
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`ps-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                ...
                                <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                  <ul
                                    className={`ps-9 mt-1 ${!open && "hidden"}`}
                                  >
                                    <li className="mb-1 last:mb-0">
                                      <NavLink
                                        end
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {/* Badge */}
                    <div className="flex flex-shrink-0 ms-2">
