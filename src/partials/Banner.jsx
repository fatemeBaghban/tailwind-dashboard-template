...
function Banner() {
  ...
  return (
    <>
    { bannerOpen && (
      <div className="fixed bottom-0 end-0 w-full md:bottom-8 md:end-12 md:w-auto z-50">
        <div className="bg-slate-800 border border-transparent dark:border-slate-700 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          ...
          <button className="text-slate-500 hover:text-slate-400 ps-2 ms-3 border-l border-gray-700" onClick={() => setBannerOpen(false) }>
