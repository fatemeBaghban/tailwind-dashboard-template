    ...
    <div className="relative">
      ...
      >
        <span className="flex items-center">
          <svg className="w-4 h-4 fill-current text-slate-500 dark:text-slate-400 shrink-0 me-2" viewBox="0 0 16 16">
            <path d="M15 2h-2V0h-2v2H9V0H7v2H5V0H3v2H1a1 1 0 00-1 1v12a1 1 0 001 1h14a1 1 0 001-1V3a1 1 0 00-1-1zm-1 12H2V6h12v8z" />
          </svg>
          <span>{options[selected].period}</span>
        </span>
        <svg className="shrink-0 ms-1 fill-current text-slate-400" width="11" height="7" viewBox="0 0 11 7">
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className="z-10 absolute top-full end-0 w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        ...
        >
          {
            options.map(option => {
              return (
                ...
                >
                  <svg className={`shrink-0 me-2 fill-current text-indigo-500 ${option.id !== selected && 'invisible'}`} width="12" height="9" viewBox="0 0 12 9">
